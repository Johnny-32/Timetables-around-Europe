...
let warsawMarker = L.marker([52.23, 21.011111]).addTo(map).bindPopup('<a href="https://www.wtp.waw.pl/rozklady-jazdy/" target="_blank">Amsterdam</a>');
let parisMarker = L.marker([48.8567, 2.3522]).addTo(map).bindPopup('<a href="https://www.ratp.fr/en/horaires-bus" target="_blank">Berlin</a>');
